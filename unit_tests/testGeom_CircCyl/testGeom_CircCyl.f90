...
SUBROUTINE testOnSurface()
  ...
  CALL point%clear()
  CALL point%init(COORD=(/8.1174999999999997_SRK,-10.7075_SRK/))
  CALL circle%set(point,13.5_SRK)
  CALL point%clear()
  CALL point%init(COORD=(/21.61750000000000_SRK,-10.70750000000000_SRK/))
  ASSERT(circle%onSurface(point),'0 degrees')
  CALL point%clear()
  CALL point%init(COORD=(/17.66344154601840_SRK,-1.16155845398161_SRK/))
  ASSERT(circle%onSurface(point),'45 degrees')
  CALL point%clear()
  CALL point%init(COORD=(/8.11750000000000_SRK,2.79250000000000_SRK/))
  ASSERT(circle%onSurface(point),'90 degrees')
  CALL point%clear()
  CALL point%init(COORD=(/-1.42844154601839_SRK,-1.16155845398161_SRK/))
  ASSERT(circle%onSurface(point),'135 degrees')
  CALL point%clear()
  CALL point%init(COORD=(/-5.38250000000000_SRK,-10.70750000000000_SRK/))
  ASSERT(circle%onSurface(point),'180 degrees')
  CALL point%clear()
  CALL point%init(COORD=(/-1.42844154601839_SRK,-20.25344154601840_SRK/))
  ASSERT(circle%onSurface(point),'225 degrees')
  CALL point%clear()
  CALL point%init(COORD=(/8.11750000000000_SRK,-24.20750000000000_SRK/))
  ASSERT(circle%onSurface(point),'270 degrees')
  CALL point%clear()
  CALL point%init(COORD=(/17.66344154601840_SRK,-20.25344154601840_SRK/))
  ASSERT(circle%onSurface(point),'315 degrees')
